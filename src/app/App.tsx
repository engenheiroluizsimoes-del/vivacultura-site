            ...
            <div className="hero-grid grid lg:grid-cols-[1.08fr_0.92fr] gap-10 lg:gap-16 items-center">
              <div className="hero-copy" data-reveal>
                ...
                <p className="mt-5 text-sm sm:text-base font-bold uppercase tracking-[0.18em] text-[var(--color-graphite)]/60">
                  Cultura viva | Formação | Inclusão | Transformação social
                </p>
                ...
                <p className="mt-6 max-w-2xl text-base sm:text-lg md:text-xl text-[var(--color-graphite)]/78 leading-relaxed">
                  No Instituto Viva Cultura, aproximamos pessoas da arte, da formação e das oportunidades
                  culturais com ações acolhedoras, estruturadas e relevantes para a comunidade.
                </p>
                <p className="mt-4 max-w-2xl text-sm sm:text-base text-[var(--color-graphite)]/70 leading-relaxed">
                  Promovemos desenvolvimento humano e social por meio de formações artísticas estruturadas,
                  ampliando o acesso e gerando transformação social com escuta, presença institucional e impacto real.
                </p>
                ...
                <div className="hero-metrics reveal-grid mt-10 grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-xl">
                  ...
                  <div className="metric-card glass-card rounded-2xl p-4 border border-black/5 shadow-soft">
                    <div className="text-2xl font-black text-[var(--color-purplev)]">Inclusão</div>
                    <div className="mt-1 text-sm text-[var(--color-graphite)]/70">Oportunidades reais e transformação social</div>
                  </div>
                </div>
              </div>

              <div className="hero-visual relative" data-reveal>
            ...
            <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-10 items-start">
              <div>
                ...
                <h2 className="mt-4 text-4xl md:text-5xl font-black tracking-tight text-[var(--color-graphite)]">
                  Muito além de eventos, somos transformação cultural com presença humana e compromisso social.
                </h2>
                <p className="mt-6 text-lg text-[var(--color-graphite)]/78 leading-relaxed max-w-3xl">
                  Somos a cultura em movimento: atuamos para que a cultura acolha, a formação gere autonomia e a inclusão
                  crie caminhos reais para artistas, alunos, parceiros e comunidade. {instituto.textoQuemSomos}
                </p>
              </div>
              <div className="motion-card rounded-[2rem] bg-[var(--color-graphite)] text-white p-8 shadow-soft">
                ...
                <p className="mt-4 text-2xl font-bold leading-tight">
                  Arte que acolhe, acesso que transforma e impacto real, social e cultural para todos.
                </p>
